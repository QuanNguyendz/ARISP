...
namespace ARISP.API.Services
{
    ...
    /// để FE nhận ReceiveQuestion / ReceiveAnswerAnalysis / ReceiveSessionStatus realtime.
    /// Email/Slack/Teams uỷ thác cho IEmailService (giữ hành vi như Mock cũ).
    /// </summary>
    public class SignalRNotificationService : INotificationService
    {
        ...
        public Task PublishInterviewSessionEventAsync(Guid sessionId, string eventType, object payload, CancellationToken ct = default)
        {
            ...
            return _hub.Clients.Group(sessionId.ToString()).SendAsync(eventType, payload, ct);
        }
    }
}
