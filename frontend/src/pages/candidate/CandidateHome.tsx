...
function ApplicationCard({ job }: { job: typeof applications[0] }) {
  const status = APPLICATION_STATUS[job.status as keyof typeof APPLICATION_STATUS];
  ...
  return (
    <motion.div
      ...
      className="glass p-5 hover:bg-surface-hover transition-colors"
    >
...
function RecommendedJobCard({ job }: { job: typeof recommendedJobs[0] }) {
  return (
    <div className="glass p-5 hover:bg-surface-hover transition-colors group cursor-pointer">
      <div className="flex items-start gap-4">
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/5">
        ...
        <button className="px-4 py-2 rounded-lg bg-accent-primary/20 text-accent-primary text-sm font-medium hover:bg-accent-primary hover:text-white transition-colors">
          Ứng tuyển
        </button>
      </div>
    </div>
      ...
      <div className="min-h-screen py-8">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold text-white mb-2">Xin chào, Nguyễn Văn A! 👋</h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link to="/candidate/applications" className="text-sm text-accent-primary hover:text-accent-secondary transition-colors flex items-center gap-1">
                    Xem tất cả
