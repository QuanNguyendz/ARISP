...
const sidebarItems = [
  ...
  { icon: Users, label: 'Quản lý Users', path: '/super-admin/users' },
  { icon: UserCheck, label: 'Duyệt User mới', path: '/super-admin/users/pending' },
  { icon: FileText, label: 'Tin tuyển dụng', path: '/super-admin/jobs' },
      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b border-white/5">
          <Link to="/super-admin/dashboard" className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-teal flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-3 border-t border-white/5">
          <div className="flex items-center gap-3 p-2 rounded-xl bg-white/5">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500/30 to-teal/30 flex items-center justify-center text-xs font-medium text-white flex-shrink-0">
            ...
            <AnimatePresence>
              {!isSidebarCollapsed && (
                ...
                >
                  ...
                  <p className="text-xs text-emerald-400 truncate">Super Admin</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
          ...
          <>
            ...
            >
              ...
              <div className="h-16 flex items-center justify-between px-4 border-b border-white/5">
                <Link to="/super-admin/dashboard" className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-teal flex items-center justify-center">
                    <Shield className="w-4 h-4 text-white" />
                  </div>
              ...
              <div className="p-3 border-t border-white/5">
                <div className="flex items-center gap-3 p-2 rounded-xl bg-white/5">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500/30 to-teal/30 flex items-center justify-center text-xs font-medium text-white">
                    {getInitials(user?.name)}
                  </div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden h-16 flex items-center justify-between px-4 bg-black/40 backdrop-blur-xl border-b border-white/5">
          ...
          <Link to="/super-admin/dashboard" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-500 to-teal flex items-center justify-center">
              <Shield className="w-4 h-4 text-white" />
            </div>
            <span className="text-base font-semibold text-white">Super Admin</span>
          </Link>
