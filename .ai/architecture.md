...
**Kiểm chứng.** 17 test mới (7 cho luồng duyệt-kèm-ca gồm ca đầy/quá khứ/sai tin/sai vòng, 5 cho cổng ngân hàng đề, 2 cho phỏng vấn thử ở vòng trắc nghiệm, 3 cho phỏng vấn thử sau khi lỡ buổi) → **822/822 pass** (đã xoá 6 test của endpoint `send-invite` không còn tồn tại); build backend + typecheck + build cả hai site FE pass.
