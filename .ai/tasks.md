...
- [x] 2026-08-06: **Lỗi xem CV DOCX trên production — bucket R2 thiếu CORS rule.**
  ...
  - **Còn tồn:** 19 hồ sơ giữ key kiểu cũ `/uploads/<guid>` từ thời `Provider=Local`, chưa được migrate sang R2 → nay presign vào R2 không có object nên hỏng link. Cần quyết định: copy file lên R2 rồi đổi key, hay chấp nhận mất.
