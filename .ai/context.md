...
ARISP là nền tảng tuyển dụng B2B SaaS. AI tự động phỏng vấn ứng viên qua nhiều vòng, đánh giá Pass/Not Pass, HR xác nhận. Không cần nhân sự nội bộ tham gia trực tiếp vào buổi phỏng vấn.

**Mô hình kinh doanh:** B2B SaaS – Enterprise subscription.
...
| **Candidate** | Tham gia phỏng vấn AI (remote/on-site), xem lại recording & feedback qua Candidate Portal |
...
- Candidate nhận invite → submit CV + thông tin cá nhân.
