...
/// <summary>Xoá mềm playbook (<see cref="DeletePlaybookCommandHandler"/>, test-plan B29): đặt DeletedAt/UpdatedAt; id lạ → NotFound.</summary>
public class DeletePlaybookCommandHandlerTests
{
    [Fact]
    public async Task Soft_deletes_the_document()
    {
    ...
    {
        var res = await new DeletePlaybookCommandHandler(new InMemoryUnitOfWork())
