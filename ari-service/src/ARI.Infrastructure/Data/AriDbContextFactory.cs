...
namespace ARI.Infrastructure.Data
{
    ...
    /// </summary>
    public class AriDbContextFactory : IDesignTimeDbContextFactory<AriDbContext>
    {
        public AriDbContext CreateDbContext(string[] args)
        {
